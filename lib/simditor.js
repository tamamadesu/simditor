...
var AlignmentButton, BlockquoteButton, BoldButton, Button, Clipboard, CodeButton, CodePopover, ColorButton, EmojiButton, FontSizeButton, FormatButton, Formatter, HTMLButton, HrButton, ImageButton, ImagePopover, IndentButton, Indentation, InputManager, ItalicButton, Keystroke, LinkButton, LinkPopover, ListButton, MarginBottomButton, MarginTopButton, OrderListButton, OutdentButton, Popover, Selection, Simditor, SimditorMark, StrikethroughButton, TableButton, TitleButton, Toolbar, UnderlineButton, UndoManager, UnorderListButton, Util, VideoButton, VideoPopover, charsContent, marginMenu,
...
charsContent = [
  {
    name: "tsfh",
    title: "特殊字符",
    content: "、,。,·,ˉ,ˇ,¨,〃,々,—,～,‖,…,‘,’,“,”,〔,〕,〈,〉,《,》,「,」,『,』,〖,〗,【,】,±,×,÷,∶,∧,∨,∑,∏,∪,∩,∈,∷,√,⊥,∥,∠,⌒,⊙,∫,∮,≡,≌,≈,∽,∝,≠,≮,≯,≤,≥,∞,∵,∴,♂,♀,°,′,″,℃,＄,¤,￠,￡,‰,§,№,☆,★,○,●,◎,◇,◆,□,■,△,▲,※,→,←,↑,↓,〓,〡,〢,〣,〤,〥,〦,〧,〨,〩,㊣,㎎,㎏,㎜,㎝,㎞,㎡,㏄,㏎,㏑,㏒,㏕,︰,￢,￤,℡,ˊ,ˋ,˙,–,―,‥,‵,℅,℉,↖,↗,↘,↙,∕,∟,∣,≒,≦,≧,⊿,═,║,╒,╓,╔,╕,╖,╗,╘,╙,╚,╛,╜,╝,╞,╟,╠,╡,╢,╣,╤,╥,╦,╧,╨,╩,╪,╫,╬,╭,╮,╯,╰,╱,╲,╳,▁,▂,▃,▄,▅,▆,▇,�,█,▉,▊,▋,▌,▍,▎,▏,▓,▔,▕,▼,▽,◢,◣,◤,◥,☉,⊕,〒,〝,〞".split(",")
  }, {
    name: "lmsz",
    title: "罗马字符",
    content: "ⅰ,ⅱ,ⅲ,ⅳ,ⅴ,ⅵ,ⅶ,ⅷ,ⅸ,ⅹ,Ⅰ,Ⅱ,Ⅲ,Ⅳ,Ⅴ,Ⅵ,Ⅶ,Ⅷ,Ⅸ,Ⅹ,Ⅺ,Ⅻ".split(",")
  }, {
    name: "szfh",
    title: "数学字符",
    content: "⒈,⒉,⒊,⒋,⒌,⒍,⒎,⒏,⒐,⒑,⒒,⒓,⒔,⒕,⒖,⒗,⒘,⒙,⒚,⒛,⑴,⑵,⑶,⑷,⑸,⑹,⑺,⑻,⑼,⑽,⑾,⑿,⒀,⒁,⒂,⒃,⒄,⒅,⒆,⒇,①,②,③,④,⑤,⑥,⑦,⑧,⑨,⑩,㈠,㈡,㈢,㈣,㈤,㈥,㈦,㈧,㈨,㈩".split(",")
    ...
    name: "xlzm",
    title: "希腊字母",
    content: "Α,Β,Γ,Δ,Ε,Ζ,Η,Θ,Ι,Κ,Λ,Μ,Ν,Ξ,Ο,Π,Ρ,Σ,Τ,Υ,Φ,Χ,Ψ,Ω,α,β,γ,δ,ε,ζ,η,θ,ι,κ,λ,μ,ν,ξ,ο,π,ρ,σ,τ,υ,φ,χ,ψ,ω".split(",")
  }, {
    name: "ewzm",
    title: "俄文字符",
    content: "А,Б,В,Г,Д,Е,Ё,Ж,З,И,Й,К,Л,М,Н,О,П,Р,С,Т,У,Ф,Х,Ц,Ч,Ш,Щ,Ъ,Ы,Ь,Э,Ю,Я,а,б,в,г,д,е,ё,ж,з,и,й,к,л,м,н,о,п,р,с,т,у,ф,х,ц,ч,ш,щ,ъ,ы,ь,э,ю,я".split(",")
  }, {
    name: "pyzm",
    title: "拼音字母",
    content: "ā,á,ǎ,à,ē,é,ě,è,ī,í,ǐ,ì,ō,ó,ǒ,ò,ū,ú,ǔ,ù,ǖ,ǘ,ǚ,ǜ,ü".split(",")
  }, {
    name: "yyyb",
    title: "英语音标",
    content: "i:,i,e,æ,ʌ,ə:,ə,u:,u,ɔ:,ɔ,a:,ei,ai,ɔi,əu,au,iə,εə,uə,p,t,k,b,d,g,f,s,ʃ,θ,h,v,z,ʒ,ð,tʃ,tr,ts,dʒ,dr,dz,m,n,ŋ,l,r,w,j,".split(",")
  }, {
    name: "zyzf",
    title: "其他",
    content: "ㄅ,ㄆ,ㄇ,ㄈ,ㄉ,ㄊ,ㄋ,ㄌ,ㄍ,ㄎ,ㄏ,ㄐ,ㄑ,ㄒ,ㄓ,ㄔ,ㄕ,ㄖ,ㄗ,ㄘ,ㄙ,ㄚ,ㄛ,ㄜ,ㄝ,ㄞ,ㄟ,ㄠ,ㄡ,ㄢ,ㄣ,ㄤ,ㄥ,ㄦ,ㄧ,ㄨ".split(",")
  }
];
...
MarginTopButton = (function(superClass) {
  ...
  MarginTopButton.prototype.name = "marginTop";

  MarginTopButton.prototype.icon = "margin mdi-icon mdi-editor-vertical-align-top";

  MarginTopButton.prototype._init = function() {
    this.title = "上边距";
    this.menu = marginMenu;
    return MarginTopButton.__super__._init.call(this);
  };
...
MarginBottomButton = (function(superClass) {
  ...
  MarginBottomButton.prototype.name = "marginBottom";

  MarginBottomButton.prototype.icon = "margin mdi-icon mdi-editor-vertical-align-Bottom";
...
VideoButton = (function(superClass) {
  ...
  VideoButton.prototype._videoTpl = "<p><iframe width=\"620\" height=\"500\" frameborder=0 allowFullScreen=\"true\" quality=\"high\" align=\"middle\" allowScriptAccess=\"always\" src=\"---video-src---\"></iframe></p>";

  VideoButton.prototype.name = "video";

  VideoButton.prototype.icon = "video mdi-icon mdi-av-videocam";
...
EmojiButton = (function(superClass) {
  ...
  EmojiButton.prototype.renderMenu = function() {
    var $list, con, html, k, len, ref, tpl;
    tpl = '<div class="emoji-list">\n</div>';
    html = "";
    ref = charsContent[0].content;
    for (k = 0, len = ref.length; k < len; k++) {
      con = ref[k];
      html += "<span>" + con + "</span>";
    }
    ...
    return $list.on('mousedown', 'span', (function(_this) {
      return function(e) {
        var $moji, txtNode;
        _this.wrapper.removeClass('menu-on');
        if (!_this.editor.inputManager.focused) {
        ...
        _this.editor.selection.insertNode(txtNode);
        _this.editor.trigger('valuechanged');
        _this.editor.trigger('selectionchanged');
        return false;
      };
